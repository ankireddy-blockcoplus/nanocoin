...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "nanocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nanocointools.com", "dnsseed.nanocointools.com"},
    {"nanocoinpool.org", "dnsseed.nanocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"nanocointools.com", "testnet-seed.nanocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. nanocoin is probably already running."), addrBind.ToString().c_str());
        else
